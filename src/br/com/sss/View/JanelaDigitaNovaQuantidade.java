 ...
 * @author Diego Rangel
 */
public class JanelaDigitaNovaQuantidade extends javax.swing.JDialog {

    public boolean preencheu = false;
    
    /**
     * Creates new form JanelaDigitaNovaQuantidade
     */
    public JanelaDigitaNovaQuantidade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        super.setTitle("Digite a quantidade!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaDigitaNovaQuantidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JanelaDigitaNovaQuantidade dialog = new JanelaDigitaNovaQuantidade(new javax.swing.JFrame(), true);
